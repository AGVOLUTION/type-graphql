import { ObjectTypeDefinitionNode, InputObjectTypeDefinitionNode, GraphQLOutputType, FieldDefinitionNode, GraphQLInputType, InputValueDefinitionNode, DirectiveNode, ObjectTypeExtensionNode } from "graphql";
import { DirectiveMetadata } from "../metadata/definitions";
export declare function getObjectTypeDefinitionNode(name: string, directiveMetadata?: DirectiveMetadata[], isObjectTypeExtension?: boolean): ObjectTypeDefinitionNode | ObjectTypeExtensionNode | undefined;
