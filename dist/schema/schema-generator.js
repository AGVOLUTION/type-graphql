        ...
        this.objectTypesInfo = getMetadataStorage_1.getMetadataStorage().objectTypes.map(objectType => {
            ...
            return {
                ...
                type: new graphql_1.GraphQLObjectType({
                    ...
                    astNode: definition_node_1.getObjectTypeDefinitionNode(objectType.name, objectType.directives, objectType.isObjectTypeExtension),
                    extensionASTNodes: objectType.isObjectTypeExtension ? [{ kind: "ObjectTypeExtension", name: { kind: "Name", value: objectType.name } }] : undefined,
